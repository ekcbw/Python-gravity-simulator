# -*- coding: utf-8 -*-
# 行星碰撞模拟(备用)
# 碰撞算法原理：https://blog.csdn.net/ekcbw_/article/details/119711166
import sys,os
try:
    ...
    def check_collision(self):
        for planet in self.gs.planets:
            ...
            if self.hit(planet):
                ...
                rate = 0.9 # 碰撞的"弹性", 0为完全非弹性碰撞, 1为弹性碰撞
...
##              2.3,has_orbit=False,shape=('yellow',))
    ...
    for i in range(20):
        ...
        ast.x,ast.y=ast.pos()
        ast.dx,ast.dy = -ast.pos()[1]/10, ast.pos()[0]/10
        ast.color("green")
##    core=RoundStar(gs,"核", AST_MASS*1,(10,0),(0,0),1)#1.5)
##    core.color('brown')
