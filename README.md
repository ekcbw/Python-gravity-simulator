...
项目源代码 (Project source code)：https://github.com/ekcbw/python-gravity-simulation
## 一.各个文件的介绍
...
TESTs/solar_system_blackhole2.py：行星掉入黑洞的模拟2（包含了turtle模块绘制旋转图片的技巧，见 [这篇文章](https://blog.csdn.net/ekcbw_/article/details/120584657)）
